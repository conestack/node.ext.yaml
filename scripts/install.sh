...
if [ -x "$(which python)" ]; then
    ...
    ./py2/bin/pip install https://github.com/conestack/node/archive/sequence_node.zip
...
if [ -x "$(which python3)" ]; then
    ...
    ./py3/bin/pip install https://github.com/conestack/node/archive/sequence_node.zip
